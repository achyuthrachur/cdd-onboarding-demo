...
// Only includes actual changes (MODIFIED, NEW, REMOVED) - excludes UNCHANGED items
          ...
          rows: [
            {
              ...
              Impact: "High",
              Old_Requirement_ID: "1.A",
              Old_Requirement_Text: "Board-Level Accountability for CIP/CDD Programs: The Bank X Board of Directors maintains ultimate accountability for the effectiveness of Customer Identification Program and Customer Due Diligence standards across global operations through Risk Committee oversight.",
              Current_Requirement_ID: "1.A",
              Current_Requirement_Text: "Board-Level Accountability for CIP/CDD Programs: The Bank X Board of Directors maintains ultimate accountability for the effectiveness of Customer Identification Program and Customer Due Diligence standards across global operations through Risk Committee oversight, with quarterly reporting requirements.",
            },
            {
              Change_ID: "CHG-0002",
              Change_Type: "MODIFIED",
              Impact: "Medium",
              Old_Requirement_ID: "2.A",
              Old_Requirement_Text: "Bank X must obtain the following identifying information from each customer before opening an account, consistent with 31 CFR 1020.220, applicable regulatory guidance, and FFIEC examination expectations: Universal Requirements for All Customers: Name, Physical Address, Identification Number.",
              Current_Requirement_ID: "2.A",
              Current_Requirement_Text: "Bank X must obtain the following identifying information from each customer before opening an account, consistent with 31 CFR 1020.220, applicable regulatory guidance, and FFIEC examination expectations. Enhanced timing flexibility allows collection within reasonable period post-opening for certain low-risk customers.",
            },
            {
              Change_ID: "CHG-0003",
              Change_Type: "NEW",
              ...
              Current_Requirement_ID: "2.B",
              Current_Requirement_Text: "Bank X implements comprehensive risk-based identity verification procedures that consider multiple factors including customer risk profile, product type, and jurisdiction requirements.",
            },
            {
              Change_ID: "CHG-0004",
              Change_Type: "MODIFIED",
              Impact: "Medium",
              Old_Requirement_ID: "3.A",
              Old_Requirement_Text: "Documentary verification methods include government-issued identification documents such as passport, driver's license, or state-issued ID card.",
              Current_Requirement_ID: "3.A",
              Current_Requirement_Text: "Documentary verification methods include government-issued identification documents and electronic verification services. Digital identity verification through approved third-party providers is now acceptable for standard-risk customers.",
            },
            {
              Change_ID: "CHG-0005",
              Change_Type: "NEW",
              ...
              Old_Requirement_ID: "N/A",
              Old_Requirement_Text: "",
              Current_Requirement_ID: "4.C",
              Current_Requirement_Text: "Jurisdiction-based Enhanced Due Diligence (EDD) is required for all customers domiciled in or conducting significant business with FATF high-risk jurisdictions. Enhanced monitoring frequency applies.",
            },
            {
              Change_ID: "CHG-0006",
              Change_Type: "MODIFIED",
              Impact: "High",
              Old_Requirement_ID: "5.A",
              Old_Requirement_Text: "Beneficial ownership certification is required for legal entity customers. The bank must identify all individuals who own 25% or more of the entity.",
              Current_Requirement_ID: "5.A",
              Current_Requirement_Text: "Beneficial ownership certification is required for legal entity customers. The bank must identify all individuals who own 25% or more of the entity AND verify their identity using CIP-compliant methods. Annual recertification required.",
            },
            {
              Change_ID: "CHG-0007",
              Change_Type: "MODIFIED",
              Impact: "Medium",
              Old_Requirement_ID: "6.B",
              Old_Requirement_Text: "OFAC screening must be performed at account opening for the entity and all related parties.",
              Current_Requirement_ID: "6.B",
              Current_Requirement_Text: "OFAC screening must be performed at account opening for the entity, beneficial owners, authorized signers, and all related parties. Automated real-time screening integration required for transaction monitoring.",
            },
            {
              Change_ID: "CHG-0008",
              Change_Type: "MODIFIED",
              Impact: "Medium",
              Old_Requirement_ID: "6.C",
              Old_Requirement_Text: "PEP screening is required for foreign politically exposed persons at account opening.",
              Current_Requirement_ID: "6.C",
              Current_Requirement_Text: "PEP screening is required for both domestic and foreign politically exposed persons at account opening. Enhanced due diligence procedures apply to all identified PEPs and their close associates.",
            },
            {
              Change_ID: "CHG-0009",
              Change_Type: "NEW",
              ...
              Old_Requirement_ID: "N/A",
              Old_Requirement_Text: "",
              Current_Requirement_ID: "7.A",
              Current_Requirement_Text: "Adverse media screening must be performed at customer onboarding and periodically thereafter based on risk rating. High-risk customers require screening at least annually.",
            },
            {
              Change_ID: "CHG-0010",
              Change_Type: "REMOVED",
              Impact: "Low",
              Old_Requirement_ID: "8.D",
              Old_Requirement_Text: "Site visits are mandatory for address verification of commercial customers with credit exposure exceeding $1 million.",
            ...
            },
            {
              ...
              Change_Type: "MODIFIED",
              Impact: "Low",
              Old_Requirement_ID: "9.A",
              Old_Requirement_Text: "Customer notice of CIP requirements must be provided in writing at account opening.",
              Current_Requirement_ID: "9.A",
              Current_Requirement_Text: "Customer notice of CIP requirements must be provided at account opening through written or electronic delivery methods. Digital acknowledgment is acceptable.",
            },
            {
              Change_ID: "CHG-0012",
              Change_Type: "REMOVED",
              Impact: "Low",
              Old_Requirement_ID: "10.E",
              Old_Requirement_Text: "Notarized documents are required for all trust account certifications and powers of attorney.",
              Current_Requirement_ID: "N/A",
              Current_Requirement_Text: "",
            },
          ],
