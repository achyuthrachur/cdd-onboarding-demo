...
const DISPOSITION_COLORS: Record<string, string> = {
  "Meets": "bg-crowe-teal/20 text-crowe-teal-dark dark:text-crowe-teal-bright",
  "Partially Meets": "bg-crowe-amber/20 text-crowe-amber-dark dark:text-crowe-amber-bright",
  "Does Not Meet": "bg-crowe-coral/20 text-crowe-coral-dark dark:text-crowe-coral-bright",
  "Conflict": "bg-crowe-violet/20 text-crowe-violet-bright",
  "Exceeds": "bg-crowe-blue/20 text-crowe-blue-dark dark:text-crowe-blue-light",
  "N/A": "bg-tint-100 dark:bg-white/10 text-tint-700 dark:text-white/80",
};
          ...
          {summary.map((item) => (
            <Card key={item.Metric}>
              <CardContent className="p-3 text-center flex flex-col items-center justify-center min-h-[80px]">
                ...
                <p className="text-xs text-tint-700 dark:text-white/80">{item.Metric}</p>
              </CardContent>
            </Card>
          ))}
        </div>
            ...
            <Table>
              ...
              <TableBody>
                {filteredGaps.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={5} className="text-center py-8 text-tint-700 dark:text-white/80">
                          ...
                          <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
                            ...
                            <div className="space-y-4 mt-4">
                              <div>
                                ...
                                <p className="text-sm text-tint-700 dark:text-white/80">{gap.Standard_Requirement_Text}</p>
                              </div>
                              <div>
                              ...
                              <div>
                                ...
                                <p className="text-sm text-tint-700 dark:text-white/80">{gap.Impact_Rationale}</p>
                              </div>
                              <div>
                                <h4 className="font-semibold text-sm mb-1">Testing Implication</h4>
                                <p className="text-sm text-tint-700 dark:text-white/80">{gap.Testing_Implication}</p>
                              </div>
                              <div>
                              ...
                              <div>
                                ...
                                <p className="text-sm text-tint-700 dark:text-white/80">{gap.Evidence_Expected}</p>
                              </div>
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  <h4 className="font-semibold text-sm mb-1">Standard Citation</h4>
                                  <p className="text-xs text-tint-700 dark:text-white/80">{gap.Standard_Citation}</p>
                                </div>
                                <div>
                                  <h4 className="font-semibold text-sm mb-1">Procedure Citation</h4>
                                  <p className="text-xs text-tint-700 dark:text-white/80">{gap.Procedure_Citation}</p>
                                </div>
                              </div>
                              {gap.Notes && (
                                <div>
                                  <h4 className="font-semibold text-sm mb-1">Notes</h4>
                                  <p className="text-sm text-tint-700 dark:text-white/80">{gap.Notes}</p>
                                </div>
                              )}
                            </div>
                          </DialogContent>
