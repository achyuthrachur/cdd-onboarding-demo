      ...
      >
        <div className="flex items-start gap-3">
          <div className="flex-shrink-0 mt-0.5">
            <GripVertical className="h-4 w-4 text-tint-700 dark:text-white/80" />
          </div>
          <div className="flex-shrink-0">
            <motion.div
              className="flex h-10 w-10 items-center justify-center rounded-lg bg-tint-100 dark:bg-white/10"
              animate={isSelected && !shouldReduceMotion ? {
                scale: [1, 1.1, 1],
                transition: { duration: 0.3 }
              } : {}}
            >
              <FileText className="h-5 w-5 text-tint-700 dark:text-white/80" />
            </motion.div>
          </div>
