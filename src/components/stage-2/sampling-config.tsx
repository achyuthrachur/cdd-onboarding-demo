        ...
        {(method === "statistical" || method === "systematic") && (
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-1.5">
              ...
              />
              <p className="text-xs text-white/70">50-99.9%</p>
            </div>
            <div className="space-y-1.5">
              ...
              />
              <p className="text-xs text-white/70">Must exceed Expected Error Rate</p>
            </div>
            <div className="space-y-1.5">
              ...
              />
              <p className="text-xs text-white/70">Based on historical performance</p>
            </div>
          </div>
        )}
        ...
        {method === "percentage" && (
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="e.g., 10"
            />
            <p className="text-xs text-white/70">Required for percentage-based sampling</p>
          </div>
        )}
          ...
          <div className="grid gap-4 md:grid-cols-2 p-4 border border-crowe-blue/30 bg-crowe-blue/10 rounded-lg">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="e.g., 100"
              />
              <p className="text-xs text-white/70">Number of records to sample</p>
            </div>
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="e.g., 10"
              />
              <p className="text-xs text-white/70">Alternative to fixed sample size</p>
            </div>
