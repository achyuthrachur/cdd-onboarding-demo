...
const RESULT_OPTIONS = [
  ...
  { value: "N/A", label: "N/A", icon: MinusCircle, color: "text-gray-600 dark:text-white/80" },
  { value: "not-tested", label: "Not Tested", icon: MinusCircle, color: "text-gray-600 dark:text-white/80" },
];
    ...
    return (
      <Card className="h-full flex items-center justify-center">
        <div className="text-center">
          <User className="h-16 w-16 mx-auto mb-4 text-gray-600 dark:text-white/80 opacity-30" />
      ...
      <CardHeader className="flex-shrink-0 border-b">
        ...
        <div className="grid grid-cols-6 gap-4">
          ...
          <div className="p-3 rounded-lg text-center flex flex-col items-center justify-center min-h-[80px] bg-crowe-amber/10">
            ...
            <div className="text-xs text-gray-600 dark:text-white/80">Pass w/Obs</div>
          </div>
          <div className="p-3 rounded-lg text-center flex flex-col items-center justify-center min-h-[80px] bg-crowe-coral/10">
            ...
            <div className="text-xs text-gray-600 dark:text-white/80">Fail 1</div>
          </div>
          <div className="p-3 rounded-lg text-center flex flex-col items-center justify-center min-h-[80px] bg-crowe-amber-dark/10">
            ...
            <div className="text-xs text-gray-600 dark:text-white/80">Fail 2</div>
          </div>
          <div className="p-3 rounded-lg text-center flex flex-col items-center justify-center min-h-[80px] bg-crowe-blue/10">
            ...
            <div className="text-xs text-gray-600 dark:text-white/80">Questions</div>
          </div>
          <div className="p-3 rounded-lg text-center flex flex-col items-center justify-center min-h-[80px] bg-gray-100 dark:bg-white/10">
            <div className="text-lg font-bold text-gray-600 dark:text-white/80">{summary.naCount}</div>
            <div className="text-xs text-gray-600 dark:text-white/80">N/A</div>
          </div>
        </div>
        ...
        <div className="mt-4">
          <div className="flex items-center justify-between text-sm mb-1">
            <span className="text-gray-600 dark:text-white/80">Completion Progress</span>
            <span className="font-medium text-gray-900 dark:text-white">{summary.completionPercentage}%</span>
          </div>
          <Progress value={summary.completionPercentage} className="h-2 [&>div]:h-2" />
          <div className="text-xs text-gray-600 dark:text-white/80 mt-1">
        ...
        <div className="flex gap-3 mt-4">
          <div className="flex items-center gap-2">
            <Filter className="h-4 w-4 text-gray-600 dark:text-white/80" />
          ...
          <TableBody>
            {filteredRows.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell className="px-4 py-2 text-xs text-gray-600 dark:text-white/80 truncate max-w-[200px]" title={row.observation}>
                  {row.observation || "-"}
                </TableCell>
              </TableRow>
            ))}
            {filteredRows.length === 0 && (
              <TableRow>
                <TableCell colSpan={7} className="text-center py-8 text-gray-600 dark:text-white/80">
