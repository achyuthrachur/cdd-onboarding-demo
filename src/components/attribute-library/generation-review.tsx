...
const STATUS_COLORS: Record<string, string> = {
  Ready: "bg-crowe-teal/20 text-crowe-teal-dark dark:text-crowe-teal-bright",
  "In Progress": "bg-crowe-blue/20 text-crowe-blue-dark dark:text-crowe-blue-light",
  Completed: "bg-crowe-violet/20 text-crowe-violet-bright",
  Error: "bg-crowe-coral/20 text-crowe-coral-dark dark:text-crowe-coral-bright",
};

const PARTY_TYPE_COLORS: Record<string, string> = {
  "Individual - Domestic":
    "bg-crowe-blue/20 text-crowe-blue-dark dark:text-crowe-blue-light",
  ...
  PEP: "bg-crowe-coral/20 text-crowe-coral-dark dark:text-crowe-coral-bright",
  Trust: "bg-crowe-violet/20 text-crowe-violet-bright",
  Fund: "bg-crowe-amber/20 text-crowe-amber-dark dark:text-crowe-amber-bright",
          ...
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="flex items-center gap-2">
                ...
                <Badge
                  className={
                    STATUS_COLORS[batchConfig.Status] ||
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="space-y-1">
              <p className="text-sm text-tint-700 dark:text-white/80">Last Refresh</p>
              <p className="font-medium text-sm">{formatDate(batchConfig.LastRefresh)}</p>
            </div>
            <div className="space-y-1">
              <p className="text-sm text-tint-700 dark:text-white/80">Output Folder</p>
              <p className="font-medium text-sm truncate" title={batchConfig.OutputFolder}>
                {batchConfig.OutputFolder}
              </p>
            </div>
            <div className="space-y-1">
              <p className="text-sm text-tint-700 dark:text-white/80">Total Samples</p>
              <p className="font-medium text-sm">{batchConfig.TotalSamples}</p>
            </div>
            <div className="space-y-1">
              <p className="text-sm text-tint-700 dark:text-white/80">Assignment Status</p>
          ...
          <div className="mt-4 pt-4 border-t">
            <p className="text-sm font-medium text-tint-700 dark:text-white/80 mb-3">Primary Actions</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-xs text-tint-700 dark:text-white/80">Total Samples</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <div className="text-2xl font-bold">{Object.keys(stats.byJurisdiction).length}</div>
            <p className="text-xs text-tint-700 dark:text-white/80">Jurisdictions</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <div className="text-2xl font-bold">{stats.avgIRR.toFixed(1)}</div>
            <p className="text-xs text-tint-700 dark:text-white/80">Avg IRR</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <div className="text-2xl font-bold">{stats.avgDRR.toFixed(1)}</div>
            <p className="text-xs text-tint-700 dark:text-white/80">Avg DRR</p>
          </CardContent>
        </Card>
      </div>
            ...
            <Table>
              ...
              <TableBody>
                {filteredRows.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={10} className="text-center py-8 text-tint-700 dark:text-white/80">
