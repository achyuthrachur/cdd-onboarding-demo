...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1.5 [&>svg]:pointer-events-none focus-visible:ring-gray-400/30 dark:focus-visible:ring-white/30 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-gray-200 dark:border-white/20 text-gray-600 dark:text-white/80 bg-transparent [a&]:hover:bg-gray-100 dark:[a&]:hover:bg-white/10 [a&]:hover:text-gray-900 dark:[a&]:hover:text-white",
        ghost: "border-transparent text-gray-500 dark:text-white/70 [a&]:hover:bg-gray-100 dark:[a&]:hover:bg-white/10 [a&]:hover:text-gray-900 dark:[a&]:hover:text-white",
