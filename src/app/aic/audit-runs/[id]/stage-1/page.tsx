            ...
            <CardHeader className="pb-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-gray-600 dark:text-white/80">Old GFC vs Current GFC</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <Badge variant={assessment1Result ? "default" : "outline"} className={!assessment1Result ? "border-gray-300 dark:border-white/30 text-gray-600 dark:text-white/80" : ""}>
            ...
            <CardHeader className="pb-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-gray-600 dark:text-white/80">Current GFC vs FLU Procedures</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <Badge variant={assessment2Result ? "default" : "outline"} className={!assessment2Result ? "border-gray-300 dark:border-white/30 text-gray-600 dark:text-white/80" : ""}>
          ...
          <Card className={`bg-white dark:bg-white/10 backdrop-blur-xl border border-gray-200/60 dark:border-white/20 shadow-md dark:shadow-[0_8px_32px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.1)] ${canProceed ? "border-green-500" : ""}`}>
            <CardHeader className="pb-2">
              <div className="flex items-center gap-3">
                <motion.div
                  className={`flex h-10 w-10 items-center justify-center rounded-lg ${
                    canProceed ? "bg-green-500/20 text-green-400" : "bg-gray-100 dark:bg-white/10 text-gray-500 dark:text-white/80"
                  }`}
                >
                ...
                <div>
                  ...
                  <CardDescription className="text-gray-600 dark:text-white/80">Review & proceed</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <Badge variant={canProceed ? "default" : "outline"} className={!canProceed ? "border-gray-300 dark:border-white/30 text-gray-600 dark:text-white/80" : ""}>
